...
{{--                </div>--}}
                ...
                <div class="tyn-chat-body js-scroll-to-end" id="tynChatBody">
                    @foreach($messages as $message)
                        <div class="tyn-reply" id="tynReply">
                            <div class="tyn-reply-item {{ $message->message_sender_id === $authUser->id ? 'outgoing' : 'incoming' }}">
                                <div class="tyn-reply-group">
                                    <div class="tyn-reply-bubble">
                                        <div class="tyn-reply" id="tynReply{{ $message->id }}">
                                            @if($message->message_sender_id != optional($authUser)->id)
                                                <div class="tyn-reply-avatar">
                                                    <div class="tyn-media tyn-size-md tyn-circle">
                                                        <img src="{{ URL::to('defult/profile.jpeg') }}" alt="">
                                                    </div>
