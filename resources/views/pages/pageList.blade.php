...
@section('content')
    ...
    <div class="w-full flex flex-col sm:flex-row gap-y-5 gap-x-8">
            ...
            <div class="w-full mr-4 p-4 rounded-md text-black dark:text-white text-base h-full overflow-y-auto">
                <div class="sidebar fixed top-14 bg-white dark:bg-black bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center shadow drop-shadow-lg">
                    ...
                    <a href="{{route('group.list')}}" class="p-2.5 mt-3 flex items-center text-black dark:text-white rounded-md px-4 duration-300 cursor-pointer">
                        ...
                        <span class="text-[15px] ml-4 text-black dark:text-white font-bold">Group</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center w-full">
            <div class="w-full">
                <div class="w-full">
                    <P class="text-black dark:text-white text-2xl font-bold">Pages</P>
                            ...
                            <div class="rounded mt-2">
                                <div class="flex flex-col sm:flex-row gap-y-6 justify-end py-2 rounded bg-gray-50 shadow drop-shadow-xl dark:bg-black">
                                    <ul id="tabs" class="inline-flex pt-2 px-1 w-full">
                                        <li class="bg-gray-200 px-4 text-green-600 font-semibold py-2 rounded-t border-t border-r border-l -mb-px"><a id="default-tab" href="#first">My Pages</a></li>
                                        <li class="px-4 text-green-600 font-semibold py-2 rounded-t"><a href="#second">Suggested Pages</a></li>
                                    </ul>
                                    <a href="{{route('page.create')}}" class="flex h-9 w-36 sm:h-13 sm:w-44 items-center justify-center gap-x-2 ml-1.5 sm:mr-3 text-center text-white transition-colors duration-150 bg-[#62bb46] rounded-md focus:shadow-outline">
                                        <i class="fas fa-plus-circle mt-1 text-center"></i>
                                        <span class="font-medium flex flex-none text-center">Create Page</span>
                                    </a>
                                </div>
                                ...
                                <div id="tab-contents">
                                    ...
                                    <div id="second" class="hidden pt-4">
                                        <div class="w-full grid grid-cols-1 md:grid-cols-2 justify-between gap-x-5 gap-y-5">
                                            <!-- Card start -->
                                            @foreach($suggestPages as $suggestPagesData)
                                            <div>
                                                <div class="max-w-lg mx-auto bg-gray-50 drop-shadow-lg dark:bg-black rounded-lg overflow-hidden shadow-lg">
                                                    <a href="{{route('page.profile',$suggestPagesData->id)}}">
                                                    <div class="px-4 pb-4 py-4">
                                                        <div class="text-center my-4">
                                                            <i class="fas fa-users text-5xl text-gray-900 dark:text-white"></i>
                                                            <div class="py-2">
